package io.hobaskos.event.web.websocket;

import io.hobaskos.event.security.SecurityUtils;
import io.hobaskos.event.web.websocket.dto.ActivityDTO;
...
import static io.hobaskos.event.config.WebsocketConfiguration.IP_ADDRESS;
