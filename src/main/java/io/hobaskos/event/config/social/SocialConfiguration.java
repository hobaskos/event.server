package io.hobaskos.event.config.social;

import io.hobaskos.event.repository.SocialUserConnectionRepository;
import io.hobaskos.event.repository.CustomSocialUsersConnectionRepository;
import io.hobaskos.event.security.social.CustomSignInAdapter;
